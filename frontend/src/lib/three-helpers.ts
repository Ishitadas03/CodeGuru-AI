...
// Simplex Noise 3D implementation for GLSL Shaders
export const GLSL_NOISE_3D = `
...
// Creates a glowing point light mesh for visual testing or nodes
export const createGlowNode = (color: string | number, size = 0.1) => {
  ...
  // Outer glow aura (transparent bigger sphere)
